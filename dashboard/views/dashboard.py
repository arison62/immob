...
from finance.services.invoice_service import invoice_service
...
class DashboardView(LoginRequiredMixin, View):
    ...
    def get(self, request):
        ...
        invoices = invoice_service.list_invoices_for_workspace(request.user)
        ...
        return render_inertia(request, "dashboard/Index", {
            ...
            "invoices": defer(invoices, merge=True)
        })
